...
void dc_motor_move_right(const dc_motor_t *_dc_motor)
{
	...
	{
		MGPIO_voidWritePortPin(_dc_motor->Pin_1_GPIO_portX , _dc_motor->Pin_1_GPIO_pinX , GPIO_HIGH);
...
void dc_motor_move_left(const dc_motor_t *_dc_motor)
{
    ...
    else
	{
    	...
    	MGPIO_voidWritePortPin(_dc_motor->Pin_2_GPIO_portX , _dc_motor->Pin_2_GPIO_pinX , GPIO_HIGH);
	}
}
